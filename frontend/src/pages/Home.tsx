...
import { 
  faShoppingCart, faMoneyBillWave, faChartLine, faDollarSign,
  faBoxes, faTruck, faShoppingBag, faBan, faUndo, faUser, faList
        ...
        <div className="card low-quantity-stock">
          ...
          <div className="stock-items">
            <div className="stock-item">
              <img src="/src/assets/Maize - Flour _ Jumia KE.jpeg" alt="Tata Salt" />
              <div>
                <h3>Maize Flour</h3>
